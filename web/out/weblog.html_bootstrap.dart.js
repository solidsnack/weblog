  ...
  join$1: function(_, separator) {
    ...
    if (separator != null && $.get$isEmpty$asx(separator) !== true) {
      ...
      for (i = 1; i < $length; ++i) {
        ...
        buffer.write$1(buffer, $.S(this.elementAt$1(this, i)));
        if ($length !== this.get$length(this))
          throw $.$$throw($.ConcurrentModificationError$(this));
      }
...
$$.SubListIterable = {"": "ListIterable;_iterable,_start,_endOrLength",
  ...
  get$length: function(_) {
    ...
    if (t2 !== (t2 | 0))
      return this.get$length$bailout2(1, $length, t1, t2);
    if (t2 >= $length)
      return $length - t1;
    return t2 - t1;
  },
...
$$._MatchImplementation = {"": "Object;pattern,str,start,end,_groups",
  group$1: function(index) {
    var t1 = this._groups;
    if (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !$.getInterceptor(t1).$isJavaScriptIndexingBehavior())
      return this.group$1$bailout(1, t1, index);
    if (index < 0 || index >= t1.length)
      throw $.ioore(index);
    return t1[index];
  },
  group$1$bailout: function(state0, t1, index) {
...
$$.Object = {"": ";",
  ...
  stream$0: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("stream", "stream$0", 0, [], []));
  },
...
$$._FrozenElementListIterator = {"": "Object;_liblib4$_list,_liblib4$_index,_current",
  moveNext$0: function() {
    var nextIndex, t1;
    nextIndex = $.$add$ns(this._liblib4$_index, 1);
...
$$._WrappedList = {"": "Object;_liblib4$_list",
  get$iterator: function(_) {
    return $._WrappedIterator$($.get$iterator$ax(this._liblib4$_list));
  },
  map$1: function(_, f) {
    return $.map$1$ax(this._liblib4$_list, f);
  },
  where$1: function(_, f) {
    return $.where$1$ax(this._liblib4$_list, f);
  },
  forEach$1: function(_, f) {
    $.forEach$1$ax(this._liblib4$_list, f);
  },
  toList$1$growable: function(_, growable) {
    return $.List_List$from(this._liblib4$_list, growable);
  },
  toList$0: function($receiver) {
    return this.toList$1$growable($receiver, true);
  },
  get$length: function(_) {
    return $.get$length$asx(this._liblib4$_list);
  },
  get$isEmpty: function(_) {
    return $.get$isEmpty$asx(this._liblib4$_list);
  },
  elementAt$1: function(_, index) {
    return $.elementAt$1$ax(this._liblib4$_list, index);
  },
  add$1: function(_, element) {
    $.add$1$ax(this._liblib4$_list, element);
  },
  addAll$1: function(_, elements) {
    $.addAll$1$ax(this._liblib4$_list, elements);
  },
  remove$1: function(_, element) {
  ...
  $index: function(_, index) {
    return $.$index$asx(this._liblib4$_list, index);
  },
  $indexSet: function(_, index, value) {
    $.$indexSet$ax(this._liblib4$_list, index, value);
  },
  get$reversed: function(_) {
    return $.get$reversed$ax(this._liblib4$_list);
  },
  indexOf$2: function(_, element, start) {
  ...
  removeLast$0: function(_) {
    return $.removeLast$0$ax(this._liblib4$_list);
  },
  sublist$2: function(_, start, end) {
    return $.sublist$2$ax(this._liblib4$_list, start, end);
  },
  sublist$1: function($receiver, start) {
    return this.sublist$2($receiver, start, null);
  },
...
$$.main__anon = {"": "Closure;",
  call$0: function() {
    $.context().logsTableStyling$0();
  },
  $isFunction: true
};

$$.SyslogCube = {"": "Object;tStart,tEnd,hostSuffix,appPrefix,logs",
  stream$0: function(_) {
    var lines, t1;
    lines = $.split$1$s(this.logs, "\n");
    $.JSArray_methods.sort$0(lines);
    t1 = $.JSArray_methods.map$1(lines, new $.SyslogCube_stream_anon());
    t1 = t1.where$1(t1, new $.SyslogCube_stream_anon0());
    return t1.toList$0(t1);
  }
};

$$.SyslogCube_stream_anon = {"": "Closure;",
  call$1: function(s) {
    return $.SyslogCube_split(s);
  },
  $isFunction: true
};

$$.SyslogCube_stream_anon0 = {"": "Closure;",
  call$1: function(l) {
    return $.$gt$n($.get$length$asx(l), 0);
  },
  $isFunction: true
};

$$.theTime_anon = {"": "Closure;",
  call$1: function(_) {
    var t, next;
    t = $.DateTime$_now();
    next = $.format$1$x($.get$secondsFormat(), t.toUtc$0());
    if ($.$eq($.now, next) !== true) {
      $.now = next;
      $.dispatch();
    }
...
$$.init_autogenerated_anon = {"": "Closure;",
  call$0: function() {
    return $.sublist$2$ax($.get$logs(), 0, 999);
  },
  $isFunction: true
};

$$.init_autogenerated_anon0 = {"": "Closure;__html0_0,__html1_1",
  call$2: function(log, __t) {
    var __e2 = this.__html0_0.cloneNode(true);
    __t.loopIterateAttr$3(__e2, new $.init_autogenerated__anon(log), new $.init_autogenerated__anon0(this.__html1_1));
    $.addAll$1$ax(__t, [document.createTextNode("\n              "), __e2, document.createTextNode("\n            ")]);
  },
  $isFunction: true
};

$$.init_autogenerated__anon = {"": "Closure;log_2",
  call$0: function() {
    return this.log_2;
  },
  $isFunction: true
...
$$.init_autogenerated__anon0 = {"": "Closure;__html1_3",
  call$2: function(field, __t) {
    var __e1, __binding0, t1;
    __e1 = $.clone$1$x(this.__html1_3, true);
    __binding0 = __t.contentBind$2(new $.init_autogenerated___anon(field), false);
    t1 = $.get$nodes$x(__e1);
    t1.add$1(t1, __binding0);
    $.addAll$1$ax(__t, [document.createTextNode(" "), __e1, document.createTextNode(" ")]);
  },
  $isFunction: true
};

$$.init_autogenerated___anon = {"": "Closure;field_4",
  call$0: function() {
    return this.field_4;
  },
  $isFunction: true
...
$$.init_autogenerated_anon1 = {"": "Closure;",
  call$0: function() {
    return $.get$length$asx($.get$logs());
  },
  $isFunction: true
};
...
$$.DateFormat = {"": "Object;_locale,_liblib7$_pattern,_formatFieldsPrivate",
  ...
  get$_formatFields: function() {
    if (this._formatFieldsPrivate == null) {
      if (this._liblib7$_pattern == null)
        this._useDefaultPattern$0();
      this._formatFieldsPrivate = this.parsePattern$1(this._liblib7$_pattern);
    }
  ...
  addPattern$2: function(inputPattern, separator) {
    ...
    if ($.containsKey$1$x(this.get$_availableSkeletons(), inputPattern) !== true) {
      t1 = this._liblib7$_pattern;
      if (t1 == null)
        this._liblib7$_pattern = inputPattern;
      else
        this._liblib7$_pattern = $.S(t1) + separator + inputPattern;
    } else {
      t1 = $.$index$asx(this.get$_availableSkeletons(), inputPattern);
      t2 = this._liblib7$_pattern;
      if (t2 == null)
        this._liblib7$_pattern = t1;
      else
        this._liblib7$_pattern = $.S(t2) + separator + $.S(t1);
    }
    return this;
  },
...
$$.Intl = {"": "Object;_locale",
  date$2: function(pattern, desiredLocale) {
    var actualLocale = desiredLocale == null ? this.get$locale(this) : desiredLocale;
    return $.DateFormat$(pattern, actualLocale);
  },
  date$1: function(pattern) {
    return this.date$2(pattern, null);
  },
  get$locale: function(_) {
    return this._locale;
  },
  toString$0: function(_) {
    return "Intl(" + $.S(this.get$locale(this)) + ")";
  },
  Intl$1: function(aLocale) {
    if (aLocale != null)
      this._locale = aLocale;
    else
      this._locale = $.Intl_getCurrentLocale();
  }
};
...
$$._DateFormatPatternField = {"": "_DateFormatField;pattern,parent",
  ...
  formatField$1: function(date) {
    ...
    switch ($.$index$asx(this.pattern, 0)) {
      ...
      case "E":
        t1 = $.$ge$n(this.get$width(this), 4) === true ? this.get$symbols().get$WEEKDAYS() : this.get$symbols().get$SHORTWEEKDAYS();
        t2 = $.JSNumber_methods.$mod(date.get$weekday(), 7);
        if (t2 !== (t2 | 0))
          throw $.iae(t2);
        if (t2 < 0 || t2 >= t1.length)
          throw $.ioore(t2);
      ...
      case "G":
        ...
        if ($.$ge$n(this.get$width(this), 4) === true) {
  ...
  formatQuarter$1: function(date) {
    ...
    if ($.$lt$n(this.get$width(this), 4) === true) {
      ...
      if (quarter !== (quarter | 0))
        throw $.iae(quarter);
      if (quarter < 0 || quarter >= t1.length)
        throw $.ioore(quarter);
      return t1[quarter];
    } else {
...
$$.FunctionProxy = {"": "Proxy;_liblib8$_port,_liblib8$_id",
  noSuchMethod$1: function(_, invocation) {
    ...
    if (invocation.get$isMethod() === true && $.$eq(invocation.memberName, "call") === true) {
      ...
      result = this._liblib8$_port.callSync$1([this._liblib8$_id, "", "apply", t1.toList$0(t1)]);
...
$$._ProxiedObjectTable = {"": "Object;_name,_nextId,_liblib8$_deletedCount,_registry<,_liblib8$_port,_globalIds,_handleStack,_scopeIndices<",
    ...
    for (t1 = this._registry, t2 = this._handleStack, t3 = this._globalIds, i = start; t4 = t2.length, i < t4; ++i) {
      ...
      if (t3.contains$1(t3, t2[i]) !== true) {
        if (i >= t2.length)
          throw $.ioore(i);
        t1.remove$1(t1, t2[i]);
        this._liblib8$_deletedCount = this._liblib8$_deletedCount + 1;
      }
    }
  ...
  _ProxiedObjectTable$0: function() {
    this._liblib8$_port.receive$1(new $.anon0(this));
  }
};
...
$.main = function() {
  $.theTime();
  $.getLogs();
  $.Duration$(0, 0, 0, 500, 0, 0);
  $.Timer_run(new $.main_anon());
};

$.SyslogCube$ = function(tStart, tEnd, hostSuffix, appPrefix, logs) {
  return new $.SyslogCube(tStart, tEnd, hostSuffix, appPrefix, logs);
};

$.SyslogCube_split = function(s) {
  var words, t1, t2, t3, fields;
  words = $.split$1$s(s, " ");
  t1 = $.JSArray_methods.take$1(words, 4);
  t1.toList$0(t1);
  if (words.length > 4) {
    t1 = $.substring$2$s(words[0], 0, 26);
    t2 = words.length;
    if (1 >= t2)
      throw $.ioore(1);
    t3 = words[1];
    if (3 >= t2)
      throw $.ioore(3);
    fields = [t1, t3, words[3], words[2]];
    t3 = $.JSArray_methods.skip$1(words, 4);
    fields.push(t3.join$1(t3, " "));
    return fields;
  } else
    return [];
};
...
$.getLogs = function() {
  ...
  $.open$3$async$x(req, "GET", "syslog", false);
  req.send();
  $.cube = $.SyslogCube$("0001-01-01", "9999-01-01", "", "", req.responseText);
  $.logs = $.stream$0$x($.cube);
};

$.theTime = function() {
  var t, next, t1, t2, milliseconds;
  t = $.DateTime$_now();
  $.updated = $.format$1$x($.get$secondsFormat(), t.toUtc$0());
  t = $.DateTime$_now();
  next = $.format$1$x($.get$secondsFormat(), t.toUtc$0());
  if ($.$eq($.now, next) !== true) {
    $.now = next;
...
$.init_autogenerated = function() {
  var _root, __html0, __html1, __html2, __html3, __t, t1, t2, __e6, __binding4, __binding5;
  _root = $.get$body$x(document);
  __html0 = document.createElement("tr");
  __html1 = document.createElement("td");
  __html2 = $._ElementFactoryProvider_createElement_html("<em>rows:</em>");
  __html3 = $._ElementFactoryProvider_createElement_html("<em>at:</em>");
  __t = $.Template$(_root);
  t1 = $.getInterceptor$x(_root);
  t2 = t1.get$nodes(_root);
  __t.loopIterateAttr$3($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t2.$index(t2, 1)), 1)), 1)), 1)), 3), new $.init_autogenerated_anon(), new $.init_autogenerated_anon0(__html0, __html1));
  t1 = t1.get$nodes(_root);
  __e6 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x(t1.$index(t1, 1)), 1)), 3)), 1);
  __binding4 = __t.contentBind$2(new $.init_autogenerated_anon1(), false);
  __binding5 = __t.contentBind$2(new $.init_autogenerated_anon2(), false);
  $.addAll$1$ax($.get$nodes$x(__e6), [document.createTextNode(" "), $.clone$1$x(__html2, true), document.createTextNode(" "), __binding4, document.createTextNode(" "), $.clone$1$x(__html3, true), document.createTextNode(" "), __binding5, document.createTextNode(" ")]);
  __t.create$0();
  __t.insert$0(__t);
};
...
$.Intl$ = function(aLocale) {
  var t1 = new $.Intl(null);
  t1.Intl$1(aLocale);
  return t1;
};
...
$.Intl_canonicalizedLocale = function(aLocale) {
  ...
  if (aLocale === "C")
    return "en_ISO";
  if (t1.get$length(aLocale) < 5 || t1.get$length(aLocale) > 6)
    return aLocale;
  if (t1.$index(aLocale, 2) !== "-" && t1.$index(aLocale, 2) !== "_")
    return aLocale;
  lastRegionLetter = t1.get$length(aLocale) === 5 ? "" : $.JSString_methods.toUpperCase$0(t1.$index(aLocale, 5));
  return t1.$index(aLocale, 0) + t1.$index(aLocale, 1) + "_" + $.JSString_methods.toUpperCase$0(t1.$index(aLocale, 3)) + $.JSString_methods.toUpperCase$0(t1.$index(aLocale, 4)) + lastRegionLetter;
};
...
$.stream$0$x = function(receiver) {
  return $.getInterceptor$x(receiver).stream$0(receiver);
};
...
Isolate.$lazy($, "logs", "logs", "get$logs", function() {
  return [];
});
Isolate.$lazy($, "secondsFormat", "secondsFormat", "get$secondsFormat", function() {
  return $.Intl$(null).date$1("yyyy-MM-ddTHH:mm:ss");
});
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,eval$1,get$sb,then$1,get$_id,get$day,create$0,get$ERAS,get$_tag,get$hour,get$node,get$year,lookup$1,toJson$0,get$AMPMS,get$_list,get$cause,get$month,process$0,_writeOn$1,callSync$1,get$MONTHS,get$_state,get$minute,get$second,moveNext$0,register$2,set$_state,_callback$2,_dispatch$1,_sendData$1,exitScope$0,get$current,get$weekday,iterSetup$2,set$_handle,_sendError$1,_sendValue$1,catchError$1,enterScope$0,firstMatch$1,get$ERANAMES,get$QUARTERS,get$WEEKDAYS,get$isWorker,get$sendPort,toSendPort$0,unregister$1,_setGlobals$0,contentBind$2,fullPattern$0,get$_callback,get$_duration,get$_registry,get$_workerId,set$_previous,_runCallback$1,get$_hashTable,get$_isolateId,get$_scheduled,get$stackTrace,runIteration$0,set$_scheduled,throwDelayed$0,_checkReplyTo$1,get$SHORTMONTHS,get$_futurePort,get$millisecond,get$$$_observers,get$NARROWMONTHS,get$_liblib3$_id,get$_receivePort,get$topEventLoop,set$$$_observers,get$SHORTQUARTERS,get$SHORTWEEKDAYS,get$_liblib5$_set,get$_nextListener,get$_scopeIndices,get$nextIsolateId,loopIterateAttr$3,set$_nextListener,set$nextIsolateId,compareAndNotify$0,get$currentContext,get$inMilliseconds,logsTableStyling$0,set$_liblib2$_next,_liblib4$_callback$1,get$STANDALONEMONTHS,get$STANDALONEWEEKDAYS,get$_hasUnhandledError,get$_resultOrListeners,get$STANDALONESHORTMONTHS,get$STANDALONENARROWMONTHS,get$millisecondsSinceEpoch,get$STANDALONESHORTWEEKDAYS,get$STANDALONENARROWWEEKDAYS".split(","), longNames = "call,call,call,call,call,eval,sb,then,_id,day,create,ERAS,_tag,hour,node,year,lookup,toJson,AMPMS,_list,cause,month,process,_writeOn,callSync,MONTHS,_state,minute,second,moveNext,register,_state=,_callback,_dispatch,_sendData,exitScope,current,weekday,iterSetup,_handle=,_sendError,_sendValue,catchError,enterScope,firstMatch,ERANAMES,QUARTERS,WEEKDAYS,isWorker,sendPort,toSendPort,unregister,_setGlobals,contentBind,fullPattern,_callback,_duration,_registry,_workerId,_previous=,_runCallback,_hashTable,_isolateId,_scheduled,stackTrace,runIteration,_scheduled=,throwDelayed,_checkReplyTo,SHORTMONTHS,_futurePort,millisecond,$_observers,NARROWMONTHS,_id,_receivePort,topEventLoop,$_observers=,SHORTQUARTERS,SHORTWEEKDAYS,_set,_nextListener,_scopeIndices,nextIsolateId,loopIterateAttr,_nextListener=,nextIsolateId=,compareAndNotify,currentContext,inMilliseconds,logsTableStyling,_next=,_callback,STANDALONEMONTHS,STANDALONEWEEKDAYS,_hasUnhandledError,_resultOrListeners,STANDALONESHORTMONTHS,STANDALONENARROWMONTHS,millisecondsSinceEpoch,STANDALONESHORTWEEKDAYS,STANDALONENARROWWEEKDAYS".split(",");
...
//@ sourceMappingURL=weblog.html_bootstrap.dart.js.map
